...
vi.mock('./TerritorialMap', () => ({
  TerritorialMap: ({ mode, earthquakes, hotspots, onSelect }: {
    mode: 'earthquake' | 'thermal-hotspot'
    earthquakes: EarthquakeEvent[]
    hotspots: ThermalHotspotEvent[]
    onSelect: (event: EarthquakeEvent | ThermalHotspotEvent) => void
  }) => {
    const event = mode === 'earthquake' ? earthquakes[0] : hotspots[0]
    return (
      <div data-testid="territorial-map">
